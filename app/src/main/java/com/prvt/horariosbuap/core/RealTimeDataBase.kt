package com.prvt.horariosbuap.ui.theme.dataBase
...
fun getNoticias(
    ...
    realTimeRef.addValueEventListener(object  : ValueEventListener{
        override fun onDataChange(dataSnapshot: DataSnapshot) {
            ...
            datosViewModel.llenarNoticias(ArrayList(noticias.reversed()))
        }

        override fun onCancelled(error: DatabaseError) {
            Log.w("OUT", "loadPost:onCancelled", error.toException())
            Toast.makeText(context, "Error al cargar, verifique su conexion a internet", Toast.LENGTH_SHORT ).show()
        }
